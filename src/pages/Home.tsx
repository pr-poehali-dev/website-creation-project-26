    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-white relative overflow-hidden flex flex-col items-center justify-center p-4">
      ...
      <div className="relative z-10">
        <Button
          ...
          size="lg"
          className="bg-gradient-to-r from-slate-800 via-slate-700 to-blue-600 hover:from-slate-700 hover:via-blue-600 hover:to-blue-700 text-white text-xl px-12 py-6 rounded-none shadow-2xl transform transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed border border-slate-600/20 font-bold tracking-wide uppercase"
        >
          {isGettingLocation ? (
